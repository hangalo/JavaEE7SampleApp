  ...
  //  @PersistenceUnit EntityManagerFactory emf;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("Times: " +request.getSession().getAttribute("count") + "</h2><br/><br/><br/>");
            
          ///  List<Customer> result = (List<Customer>)emf.createEntityManager().createNamedQuery("Customer.findAll").getResultList();
